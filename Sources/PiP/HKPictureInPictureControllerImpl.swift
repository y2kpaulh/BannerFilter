...
class HKPictureInPictureControllerImpl: HKPictureInPictureController {
    ...
    static let align: HKPictureInPictureControllerPosition = .bottomRight
    ...
    var pictureInPicturePosition: HKPictureInPictureControllerPosition = HKPictureInPictureControllerImpl.align
